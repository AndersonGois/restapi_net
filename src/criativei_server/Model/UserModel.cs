...
namespace criativei_server.Model
{
    ...
    public partial class UserModel : IValidatableObject
    {
        ...
        public UserModel(string name = default(string), string cpf = default(string), string email = default(string), string password = default(string), GenderEnum? gender = default(GenderEnum?), bool premium = default(bool), bool terms = default(bool), string id = default(string))
        {
            this.Name = name;
            this.Cpf = cpf;
            this.Email = email;
