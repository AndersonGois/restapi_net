...
namespace criativei_server.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        public User(string name = default(string), string cpf = default(string), string email = default(string), string password = default(string), GenderEnum? gender = default(GenderEnum?), bool premium = default(bool), bool terms = default(bool))
        {
            this.Name = name;
            this.Cpf = cpf;
            this.Email = email;
